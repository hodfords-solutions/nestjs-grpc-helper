...
/**
 * Fix load proto slow when nestjs hash module
 */
const grpcClients: { [classId in string]: any[] } = {};

/**
 * @publicApi
 */
export class CustomGrpcClient extends ClientProxy implements ClientGrpc {
    ...
    public createClientByServiceName(name: string) {
        ...
        const channelOptions: ChannelOptions =
            this.options && this.options.channelOptions ? this.options.channelOptions : {};
    ...
    public loadProto(): any {
        try {
            ...
            const packageDefinition =
                this.getOptionsProp(this.options, 'packageDefinition') || grpcProtoLoaderPackage.loadSync(file, loader);
